...
async function updateCartQuantity(productId, newQuantity) {
    ...
    try {
        const productRes = await fetch(`https://ripenred-backend.onrender.com/api/products/${productId}`);
        ...
        if (token) {
            await fetch(`https://ripenred-backend.onrender.com/api/users/cart/${productId}`, {
                method: "PUT",
                headers: {
