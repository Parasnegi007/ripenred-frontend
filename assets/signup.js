...
sendOtpBtn.addEventListener("click", async function () {
    ...
    try {
        const response = await fetch("https://ripenred-backend.onrender.com/api/users/send-otp-email", {
            method: "POST",
...
verifyOtpBtn.addEventListener("click", async function () {
    ...
    async function registerUser() {
        ...
        try {
            const response = await fetch("https://ripenred-backend.onrender.com/api/users/register", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
